...
<td height="60">
       ...
       <tr>
             ...
             <td align="center" >
                    ...
                    <a href="<c:url value='../include/calendar.jsp' />?year=<%=year-1%>&amp;month=<%=month%>" target="_self">
                    ...
                    <a href="<c:url value='../include/calendar.jsp' />?year=<%=year%>&amp;month=<%=month-1%>" target="_self">
