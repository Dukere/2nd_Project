	...
	*/
	...
	try{
		...
		*/
		...
		sfile = mr.getParameter("sfile");
		ofile = mr.getParameter("ofile");
		dto.setSfile(sfile);
		dto.setOfile(ofile);
		if(mr.getParameter("file1")!=""){
		/* 
			서버에 저장된 파일명 변경하기
		...
		*/
		...
		dto.setOfile(mr.getOriginalFileName("file1"));
		}
		////////////////////////////////////////////
		dto.setNum(num);
		dto.setTitle(title);
		...
		System.out.println(sfile + ofile);

		
		dao.myfileUpdate(dto);
