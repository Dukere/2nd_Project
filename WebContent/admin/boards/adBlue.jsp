...
<%
	...
	int totalRecordCount = dao.getTotalRecordCountBlue();
	...
	param.put("end", end);
	List<blueDTO> bbs = dao.selectListPageBlue(param);
								...
								<tbody>
									...
									<tr> 
										<td class="text-center"><a
											href="adBlueView.jsp?num=<%=dto.getNum()%>" ><%=vNum%></a></td>
										<td class="text-left" >
												<%=dto.getId()%>
										</td>
										<td class="text-center"><%=dto.getName()%></td>
										<td class="text-center"><%=dto.getCleandate()%></td>
