						...
						<div class="row mt-3">
							...
							<table class="table table-bordered table-hover table-striped"  style="TABLE-layout:fixed" >
								...
								<tbody>
									...
									%>
									<tr>
										<td colspan="7" align="center" height="100">등록된 게시물이
											없습니다.</td>
									</tr>
									...
									<tr> 
										...
										<td class="text-left" ><a
											href="adBoardView.jsp?num=<%=dto.getNum()%>&nowPage=<%=nowPage%>&<%=queryStr%>" >
												<%=dto.getTitle()%>
										</a></td>
										...
										<td class="text-center"><button type="button"
												...
												onclick="location.href='adBoardEdit.jsp?num=<%=dto.getNum()%>&bname=<%=bname%>';">수정</button></td>
										<td class="text-center"><button type="button"
												class="btn btn-danger"
												onclick="location.href='adDeleteProc.jsp?num=<%=dto.getNum()%>&bname=<%=bname%>';">삭제</button></td>
