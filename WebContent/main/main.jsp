...
List<BoardDTO> bbs1 = dao.selectListMain("notice",1,4);
List<BoardDTO> bbs2 = dao.selectListMain("free",1,4);
List<BoardDTO> bbs3 = dao.selectListMain("pic",1,6);
%>
<html>
<head>
		...
		<div class="main_contents">
			<div class="main_con_left">
				...
				<% }else{ %>
					...
					<p style="text-align:right; padding-right:10px;">
						...
						<a href="../common/logout.jsp"><img src="../images/login_btn05.gif" /></a>
					</p>
			...
			<div class="main_con_center">
				...
				<ul class="main_board_list">
					<% for (BoardDTO dto : bbs1) { %>
					<li><p><a href="../space/space_view.jsp?bname=notice&num=<%=dto.getNum()%>"><%=dto.getTitle()%></a><span><%=dto.getPostdate() %></span></p></li>
					<% } %>
				</ul>
			</div>
			<div class="main_con_right">
				...
				<ul class="main_board_list">
					<% for (BoardDTO dto : bbs2) { %>
					<li><p><a href="../space/space_view.jsp?bname=free&num=<%=dto.getNum()%>"><%=dto.getTitle()%></a><span><%=dto.getPostdate() %></span></p></li>
					<% } %>
				</ul>
			</div>
		</div>
		...
		<div class="main_contents">
			...
			<div class="main_con_center">
				...
				<div class="cal_top">
					<table cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							<!-- 이전달 보기 -->
							<td><img src="../images/cal_a01.gif" style="margin-top:3px;" id="month_prev"
								style="cursor:pointer"/></td>
							<!-- 연/월 표시 -->
							<td style="font-weight:bold;font-size:24px;" id="calendar_n_view">2020년 6월</td>
							<!-- 다음 달 보기 -->
							<td><img src="../images/cal_a02.gif" style="margin-top:3px;" id="month_next"
								style="cursor:pointer" /></td>
						</tr>
					</table>
				</div>
			...
			<div class="main_con_right">
				...
				<ul class="main_photo_list">
					<% for (BoardDTO dto : bbs3) { %>
						<li>
							<dl>
								<dt><a href="../space/space_view.jsp?bname=pic&num=<%=dto.getNum()%>">
							<img src="../Upload/<%=dto.getSfile()%>" width="85px"
							height="85px" alt="" /> 
						</a></dt>
								<dd><%=dto.getTitle()%></dd>
							</dl>
...
<script src="../common/bootstrap4.4.1/js/bootstrap.bundle.min.js"></script>
