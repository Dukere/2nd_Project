...
<div id="top" style="border:0px solid #000;"> 
	...
	<ul id="lnb">
		...
		<% }else{ %>
		<!-- 로그인후 -->
		<li><a href="../common/logout.jsp"><img src="../images/lnb05.gif" alt="LOG OUT" /></a></li>
	...
	<map name="GNB">
		...
		<area shape="rect" alt="" title="" coords="428,0,529,33" href="../space/space_list.jsp?bname=notice" target="" />
		<area shape="rect" alt="" title="" coords="536,0,638,33" href="../community/ComList?bname=emp" target="" />
