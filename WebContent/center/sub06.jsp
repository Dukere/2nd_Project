		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<div class="con_box">
					...
					<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=ca36a2b3fff019609043abd2b1ad96e6"></script>
					<script>
					var container = document.getElementById('map'); //지도를 담을 영역의 DOM 레퍼런스
					var options = { //지도를 생성할 때 필요한 기본 옵션
						center: new kakao.maps.LatLng(37.476051, 126.894317), //지도의 중심좌표.
						level: 3 //지도의 레벨(확대, 축소 정도)
					};
					var map = new kakao.maps.Map(container, options); //지도 생성 및 객체 리턴
					
					// 마커가 표시될 위치입니다 
					var markerPosition  = new kakao.maps.LatLng(37.476051, 126.894317); 
					...
					var iwContent = '<div style="padding:5px;">덕래 집 <br><a href="https://map.kakao.com/link/map/덕래 집,37.476051, 126.894317" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/덕래 집,37.476051, 126.894317" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
				    iwPosition = new kakao.maps.LatLng(37.476051, 126.894317); //인포윈도우 표시 위치입니다
