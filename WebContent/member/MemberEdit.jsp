		...
		<div id="wrap">
			...
			<div class="contents_box">
				...
				<div class="right_contents">
					...
					<form action="joinEditProc.jsp" method="post" name="joinFrm"> 
						...
						<table cellpadding="0" cellspacing="0" border="0" class="join_box">
							...
							<tr>
								...
								<td><input type="text" id="name" name="name" value="<%=dto.getName() %>"
									class="join_input" /></td>
							</tr>
							<tr>
								<th><img src="../images/join_tit002.gif" /></th>
								<td><input type="text" id="id" name="id" value="<%=dto.getId() %>" class="join_input" readonly/>
									<input type="hidden" id="isIdcheck" name ="isIdcheck"/></td>
							</tr>
							<tr>
								<th><img src="../images/join_tit003.gif" /></th>
								<td><input type="password" id="pass" name="pass" value="<%=dto.getPass() %>"
							...
							<tr>
								...
								<td><input type="text" id="tel1" name="tel" value="<%=dto.getTel() %>" maxlength="11"
									class="join_input" style="width: 150px;" />
							</tr>
							<tr>
								<th><img src="../images/join_tit07.gif" /></th>
								<td><input type="text" id="mobile1" name="mobile" value="<%=dto.getMobile() %>" maxlength="11"
									class="join_input" style="width: 150px;" />
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" id="zip1" name="zip" value="<%=dto.getZip() %>"
									class="join_input" style="width: 100px;" /> <a
									onclick="sample6_execDaumPostcode()"
									href="javascript:;" title="새 창으로 열림"
									onkeypress="">[우편번호검색]</a> <br /> 
									<input type="text"
									id="addr1" name="addr" value="<%=dto.getAddr() %>" class="join_input"
									style="width: 550px; margin-top: 5px;" />
									<br>
									<input type="text" id="extraAddr" name="extraaddr" value="<%=dto.getExtraaddr() %>" class="join_input"
									style="width: 550px; margin-top: 5px;" /></td>
							</tr>
						</table>
					<p style="text-align: center; margin-bottom: 20px">
						<input type="image" src="../images/btn01.gif" id="regEnd" alt="정보수정">&nbsp;&nbsp;<a
