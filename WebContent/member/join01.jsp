	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<p style="text-align:center; margin-bottom:20px"><input type="image" src="../images/btn01.gif" id="next"/>&nbsp;&nbsp;<a href="#"><img src="../images/btn02.gif" /></a></p>
